...
struct ConfirmationDialog {
    ...
    static var sample: ConfirmationDialog {
...
extension View {
    ...
    func confirmationDialog(dialog dialogBinding: Binding<ConfirmationDialog?>) -> some View {
        ZStack(alignment: .bottom) {
            ...
            if let dialog = dialogBinding.wrappedValue {
                ZStack {
                    ...
                    ConfirmationDialogView(isVisible: .init(get: {
...
struct ConfirmationDialogView_Previews: PreviewProvider {
    ...
    static var previews: some View {
        ConfirmationDialogView(isVisible: .constant(true), dialog: .sample)
            .background(
